...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/detailRecipe").permitAll()
                .antMatchers("/detailArticle").permitAll()
                .antMatchers("/detailUser").permitAll()
                .antMatchers("/allRecipes").permitAll()
                .antMatchers("/allArticles").permitAll()
                ...
                .antMatchers("/myArticles").authenticated()
                .and()
                .formLogin()
                .loginPage("/signIn")
